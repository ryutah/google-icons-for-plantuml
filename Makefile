...
.PHONY: build
build: build/google_workspace build/google_cloud build/firebase ## build sprites
...
build/firebase: ## build firebase sprice
	./scripts/firebase/download_icons.sh
	./scripts/firebase/create_sprite.sh
